...
const MyForm = () => {
    ...
    return <>
        <>
            <Input style={{ margin: '10px' }}  value={user.id} fullWidth disabled />
            ...
            <Input style={{ margin: '10px' }} onChange={handleChange('password')}type="password" placeholder="Enter Password" value={user.password} fullWidth />
